...
#line 421 "bibparse.y"
    ...
    (yyval.body)->value.sub->content  = (yyvsp[(3) - (4)].body);
}
    break;
...
#line 488 "bibparse.y"
    ...
    (yyval.body) = bibtex_struct_new (BIBTEX_STRUCT_SUB);
    (yyval.body)->value.sub->encloser = BIBTEX_ENCLOSER_BRACE;
    (yyval.body)->value.sub->content  = (yyvsp[(2) - (3)].body);
}
    break;
...
#line 527 "bibparse.y"
    ...
    (yyval.body) = bibtex_struct_append ((yyval.body), (yyvsp[(2) - (2)].body));
}
    break;
